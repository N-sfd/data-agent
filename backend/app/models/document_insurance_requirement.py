...
class DocumentInsuranceRequirement(Base):
    __tablename__ = "document_insurance_requirements"
    ...
    coverage_type: Mapped[str] = mapped_column(String(200), nullable=False, default="")
